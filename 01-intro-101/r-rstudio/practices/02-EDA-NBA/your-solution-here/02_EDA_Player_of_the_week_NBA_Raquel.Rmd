...
```{r}
library(readr)
nba <- read.csv("~/GitHub/NEOLAND-DS2020-datalabs/01-intro-101/r-rstudio/practices/02-EDA-NBA/NBA_player_of_the_week.csv", header = TRUE, sep = ",")
...
Transformamos las variables en categóricas. 
